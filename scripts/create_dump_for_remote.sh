#!/bin/bash
# Quick script to create password-protected dump for remote push
# Usage: ./scripts/create_dump_for_remote.sh [password]
...
if [ -f "$ZIP_FILE" ] && [ -s "$ZIP_FILE" ]; then
    ...
    rm -f "$DUMP_FILE"
    echo ""
    echo "✓ Original dump removed. Password-protected ZIP ready for push."
else
