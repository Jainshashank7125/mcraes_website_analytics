...
import { KPI_METADATA as SHARED_KPI_METADATA, KPI_ORDER as SHARED_KPI_ORDER } from "./reporting/constants";
import {
  formatValue,
  getSourceColor,
  getSourceLabel,
...
// Use shared KPI constants from constants.js to ensure consistency
const KPI_ORDER = SHARED_KPI_ORDER;
const KPI_METADATA = SHARED_KPI_METADATA;
      ...
      case "ga4":
        return [
          ...
          },
          {
            ...
            label: "Total Users by Channel",
            description: "Donut chart showing users distribution by channel",
          },
          {
